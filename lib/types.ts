...
export const ACTIONS: ActionMeta[] = [
  {
    ...
    href: "/estoy-a-salvo",
    title: "Estoy a salvo",
    description: "Confirmá que estás bien y en qué zona, para que tu familia lo sepa.",
  ...
  },
  {
    ...
    description: "Reportá a un familiar con quien perdiste contacto o revisá los reportes.",
  ...
  },
  {
    ...
    description: "Aportá un dato o avistamiento sobre una persona reportada.",
  ...
  },
  {
    ...
    description: "Pedí o señalá refugio, agua, atención médica y más en el mapa.",
