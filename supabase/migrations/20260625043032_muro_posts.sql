-- ============================================================
-- Muro de información ciudadana (tweets recopilados de redes).
-- Esta tabla faltaba en la migración inicial (se añadió al esquema después).
-- Mismo modelo de seguridad que el resto de contenido público:
--   · el público LEE solo filas 'approved'
--   · cualquiera INSERTA filas que entran como 'pending'
--   · moderadores aprueban/actualizan; admins borran
-- ============================================================
...
-- Políticas (idempotentes: se recrean si ya existían).
...
-- GRANT de tabla (RLS controla filas; GRANT controla acceso a la tabla).
